	...
	return (
		<AdminApp>
			<div className="p-8 space-y-6 relative">
				...
				{flashMessage && (
					<div
						className={`fixed top-4 right-4 z-50 px-4 py-3 rounded-lg shadow-lg border flex items-center gap-2 animate-in slide-in-from-top-2 duration-300 ${flashMessage.type === 'success'
